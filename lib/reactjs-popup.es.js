...
function (_React$PureComponent) {
  ...
  function Popup(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentClick", function (event) {
      if (_this.ContentEl && !_this.ContentEl.contains(event.target) || _this.TriggerEl && !_this.TriggerEl.contains(event.target)) {
        console.log('doc click', event, _typeof(_this.ContentEl), JSON.stringify(_this.ContentEl));
