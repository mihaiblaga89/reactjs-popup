...
function (_React$PureComponent) {
  ...
  function Popup(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      openedBy: null // we create this modal state because the popup can't be a tooltip if the trigger prop doesn't exist
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "togglePopup", function () {
      var _this$state = _this.state,
          ...
          openedBy = _this$state.openedBy;
      var keepOpenOnClick = _this.props.keepOpenOnClick;
      if (isOpen && keepOpenOnClick && openedBy === 'hover') return _this.setState({
        openedBy: 'click'
      });
      if (isOpen) _this.closePopup();else _this.openPopup(true);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "openPopup", function (byClick) {
      var _this$props = _this.props,
          keepOnlyOneInstanceOpen = _this$props.keepOnlyOneInstanceOpen,
      ...
      if (keepOnlyOneInstanceOpen && typeof document !== 'undefined') {
        var event = new Event('closeOtherPopovers', {
          whatToKeep: _this.uuid
        });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "closePopup", function (force) {
      if (!_this.state.isOpen || _this.props.preventClose && !force) return; // allow for the user to prevent close
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseLeave", function (event) {
      ...
      var _this$props2 = _this.props,
          ...
          keepOpenOnClick = _this$props2.keepOpenOnClick;
      var openedBy = _this.state.openedBy;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setPosition", function () {
      ...
      var _this$props3 = _this.props,
          ...
          keepTooltipInside = _this$props3.keepTooltipInside,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addWarperAction", function () {
      ...
      if (!modal && on.indexOf('hover') >= 0) {
        childrenElementProps.onMouseOver = _this.onMouseEnter;
        childrenElementProps.onMouseOut = _this.onMouseLeave;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTrigger", function () {
      ...
      return React.createElement("div", {
        onClick: onAsArray.includes('click') ? _this.togglePopup : null,
        onMouseEnter: onAsArray.includes('hover') ? _this.onMouseEnter : null,
        onMouseLeave: onAsArray.includes('hover') ? _this.onMouseLeave : null,
        onFocus: onAsArray.includes('focus') ? _this.onMouseEnter : null,
        key: "T"
      }, trigger);
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderContent", function () {
      var _this$props6 = _this.props,
          arrow = _this$props6.arrow,
          arrowStyle = _this$props6.arrowStyle;
      var modal = _this.state.modal;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentClick", function (event) {
      if (!clickedInsideOrChildren(reactDom.findDOMNode(_this.ContentEl), event.target) && !clickedInsideOrChildren(reactDom.findDOMNode(_this.TriggerEl), event.target)) {
        console.log('doc clicked', event, _typeof(_this.ContentEl), _this.ContentEl.children);
        var _this$props7 = _this.props,
            closeOnDocumentClick = _this$props7.closeOnDocumentClick,
            overridePreventCloseOnDocumentClick = _this$props7.overridePreventCloseOnDocumentClick,
            preventClose = _this$props7.preventClose;
  ...
  _createClass(Popup, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props8 = this.props,
          ...
          repositionOnResize = _this$props8.repositionOnResize,
          keepOnlyOneInstanceOpen = _this$props8.keepOnlyOneInstanceOpen;
      ...
      if (keepOnlyOneInstanceOpen && typeof document !== 'undefined') {
        document.addEventListener('closeOtherPopovers', function (event) {
          if (event.whatToKeep === _this2.uuid) return;
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.open) this.openPopup(null);else this.closePopup();
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      var _this$props9 = this.props,
          closeOnEscape = _this$props9.closeOnEscape,
          repositionOnResize = _this$props9.repositionOnResize; // remove events listeners
    ...
    value: function render() {
      var _this$props10 = this.props,
          overlayStyle = _this$props10.overlayStyle,
          closeOnDocumentClick = _this$props10.closeOnDocumentClick,
          on = _this$props10.on;
      var _this$state3 = this.state,
          modal = _this$state3.modal,
          openedBy = _this$state3.openedBy,
          isOpen = _this$state3.isOpen;
      var overlay = this.state.isOpen && closeOnDocumentClick && openedBy === 'click';
