  ...
  function Popup(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "togglePopup", function () {
      ...
      var _this$props = _this.props,
          keepOpenOnClick = _this$props.keepOpenOnClick,
          openedBy = _this$props.openedBy;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseLeave", function (event) {
      ...
      console.log('rel', e);
      console.log('ref', _this.TriggerEl);

      if (e.parentNode.parentNode.parentNode.parentNode == _this.TriggerEl || e == _this.TriggerEl) {
        return;
      }
      ...
      var _this$props2 = _this.props,
          ...
          openedBy = _this$props2.openedBy;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTrigger", function () {
      ...
      var onAsArray = Array.isArray(on) ? on : [on]; // for (let i = 0, len = onAsArray.length; i < len; i++) {
      //     switch (onAsArray[i]) {
      //         case 'click':
      ...
      return React.createElement("div", {
        ...
        onMouseOver: onAsArray.includes('hover') ? _this.onMouseEnter : null,
        onMouseOut: onAsArray.includes('hover') ? _this.onMouseLeave : null,
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          ...
          openedBy = _this$state2.openedBy;
      console.log('state', this.state);
      var overlay = this.state.isOpen && closeOnDocumentClick && openedBy !== 'hover';
