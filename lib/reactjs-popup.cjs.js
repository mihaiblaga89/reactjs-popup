...
function (_React$PureComponent) {
  ...
  function Popup(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDocumentClick", function () {
      var _this$props5 = _this.props,
          closeOnDocumentClick = _this$props5.closeOnDocumentClick,
          overridePreventCloseOnDocumentClick = _this$props5.overridePreventCloseOnDocumentClick,
          preventClose = _this$props5.preventClose;
  ...
  _createClass(Popup, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.open) this.openPopup(true);else this.closePopup();
    }
  }, {
